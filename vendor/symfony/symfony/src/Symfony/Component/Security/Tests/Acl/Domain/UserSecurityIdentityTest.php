...
class UserSecurityIdentityTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $id = new UserSecurityIdentity('foo', 'Picdump\DemoBundle\Proxy\__CG__\Symfony\Component\Security\Tests\Acl\Domain\Foo');

        $this->assertEquals('foo', $id->getUsername());
        $this->assertEquals('Picdump\DemoBundle\Proxy\__CG__\Symfony\Component\Security\Tests\Acl\Domain\Foo', $id->getClass());
    }
