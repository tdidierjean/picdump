...
namespace Symfony\Component\Security\Tests\Acl\Domain
{
    ...
    class ObjectIdentityTest extends \PHPUnit_Framework_TestCase
    {
        ...
        {
            $id = new ObjectIdentity('fooid', 'Picdump\DemoBundle\Proxy\__CG__\Symfony\Component\Security\Tests\Acl\Domain\TestDomainObject');

            $this->assertEquals('fooid', $id->getIdentifier());
            $this->assertEquals('Picdump\DemoBundle\Proxy\__CG__\Symfony\Component\Security\Tests\Acl\Domain\TestDomainObject', $id->getType());
        }
